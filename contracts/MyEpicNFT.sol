...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Aragorn", "Frodo", "Gandalf", "Legolas", "Gollum", "Sauron","Arwen","Gimli","Galadriel", "Samwise", "Bilbo", "Boromir","Pippin", "Saruman","Elrond", "Merry","Haldir", "Theoden", "Isildur","Eldarion"];

string[] secondWords = ["Meet", "Encounter", "Reach", "Unite", "Join", "Converge","Fight","Rally","Hunt","Match","Compete","Face","Endure","Races","Discharge","Muster","Quiz","Gather","Honor","Clear"];

string[] thirdWords = ["Warlock", "Puck", "Juggernaut", "Clinkz", "Chen", "Clockwerk","Alchemist", "Dazzle", "Omniknight", "Doom", "Batrider", "Earthshaker","Grimstroke","Leshrac", "Medusa", "Necrophos", "Pangolier","Pudge","Phoenix","Pugna"];
